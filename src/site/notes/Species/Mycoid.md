...
A **Mycoid** is a symbiosis of a human or [[Species/Altered Human\|altered human]] and an altered fungus. While not technically an altered human, it is still commonly classified as one, because even though the host is not necessarily altered.

Mycoids need to eat much less, but their body is occupied by two souls and two minds: one belonging to the host, and one belonging to the fungus. Which one is the more dominant one depends on upbringing.

The children of a Mycoid are always Mycoids. 
Through the fungus, Mycoids can connect to mycelium to communicate with vast stretches of flora at once, and even receive and give nutrients. To connect, all they need to do is remain in contact with the ground.
